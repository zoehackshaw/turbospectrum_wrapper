...
## Quick Start:
1. In a terminal in the same directory as this file, `ipython`
...
5. You can also edit free abundances, vsini, and any other parameters you desire, ex: `ts.Turbosynth(stellarpar=[4300,1.5,-0.5],specfile='test_spec_c1.txt',free_abund=[['C',0.1]],vsini=5)`. Note that the inputs for the free abundances are in [X/H].
